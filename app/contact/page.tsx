      ...
      <div className="page-wrap">
        ...
        <section className="contact-main">
          ...
          <div className="contact-info">
            ...
            <div className="contact-info-block">
              <h3>Location</h3>
              <p>Louviers, Normandy, France<br />& Paris, France</p>
            </div>
          ...
          {submitted ? (
            ...
            <form className="contact-form" onSubmit={handleSubmit}>
              ...
              >
                ...
                <option value="writing-courses">Writing Courses</option>
        ...
        <div className="info-cards-section">
          ...
          <div className="info-card">
            <div className="info-card-left">
              ...
              <p>Class schedules, pricing, and bookings for Normandy and Paris classes are managed at onruetatin.com.</p>
            </div>
            <a href="https://onruetatin.com" className="btn-outline-card" target="_blank" rel="noopener noreferrer">
          ...
          <div className="info-card">
            <div className="info-card-left">
              <h3>Writing Courses Waitlist</h3>
              <p>The cookbook writing programme is in development. Join the waitlist to be first when enrolment opens.</p>
            </div>
            <a href="/writing-courses" className="btn-outline-card">Join the waitlist</a>
          </div>

          <div className="info-card">
            <div className="info-card-left">
              <h3>Ghostwriting</h3>
              <p>Susan works primarily through literary agents. Have your agent reach out to susan@onruetatin.com.</p>
            </div>
            <a href="/ghostwriting" className="btn-outline-card">Learn more</a>
          </div>
