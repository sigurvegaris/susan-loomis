    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .footer-social a { font-size: 11px; font-weight: 600; letter-spacing: 0.1em; text-transform: uppercase; color: rgba(255,255,255,0.6); border: 1px solid rgba(255,255,255,0.25); padding: 6px 16px; border-radius: 999px; transition: color 0.22s ease, border-color 0.22s ease; }
        ...
        <section className="cta-section">
          <div className="cta-inner">
            ...
            <p>
              ...
              She responds to all inquiries within 3–5 business days.
            </p>
